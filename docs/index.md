...
**Note:** Credentials can also be passed in each pipeline run with `--arg token=YourToken --arg api_key=YourAPIKey`.
...
This mod is licensed under the [Apache License 2.0](https://github.com/turbot/flowpipe-mod-trello/blob/main/LICENSE).
